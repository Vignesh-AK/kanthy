...
SECRET_KEY = 'django-insecure-2j0--z%8=nas)f-1cu0$2vk7jtaowxri%srgz$#z@my)=tmi(='
...
STATICFILES_DIRS = [BASE_DIR / "static"]  # If you have additional static files in a `static/` directory
